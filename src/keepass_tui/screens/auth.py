...
def screen_enter_password(stdscr, db_path: str) -> tuple[str | None, str | None]:
    ...
    while True:
        ...
        safe_addstr(
            stdscr, 9, 3, "Ключевой файл (необязательно):", curses.color_pair(C_DIM)
        )
